  ...
  return (
    <Link
      ...
      style={{
        ...
        borderRadius: 14,
        padding: 20,
        border: `1.5px solid ${hovered ? 'oklch(0.75 0.074 260)' : 'oklch(0.92 0.02 260)'}`,
        transition: 'all 180ms',
        transform: hovered ? 'translateY(-2px)' : 'none',
        boxShadow: hovered ? '0 8px 28px oklch(0.55 0.093 260 / 0.11)' : 'none',
      }}
    ...
    >
      ...
      <div className="flex items-baseline" style={{ gap: 5 }}>
        <span style={{ fontSize: 11, color: 'oklch(0.6 0.04 260)' }}>from</span>
        <span style={{ fontSize: 22, fontWeight: 700, color: 'oklch(0.38 0.17 155)' }}>
