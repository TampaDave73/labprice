...
// Two small lead-capture forms shown in the footer on every page. Submissions land in
// VendorSuggestion/TestSuggestion (see /admin/suggestions) — nothing here writes to the live catalog.
